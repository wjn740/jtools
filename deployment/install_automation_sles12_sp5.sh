...
zypper rr qa-ibs
zypper ar http://dist.nue.suse.com/ibs/QA:/Head/SLE-12-SP5/ qa-ibs
zypper ar http://147.2.207.1/dist/install/SLP/SLE-12-SP5-SDK-LATEST/x86_64/DVD1/ qa-sdk
...
mkdir ~/qaset/
echo "_QASET_RUNID=198708"  >> ~/qaset/config
